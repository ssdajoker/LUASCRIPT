/**
 * Perl Parser - Script Language
 * Parses perl code to canonical AST for IR pipeline
 */
...
class PerlParser extends BaseParser {
  constructor(source) {
    super(source);
    this.keywords = [
      "sub", "my", "our", "use", "require", "package", "if", "unless", "while", "until", "for", "foreach", "last", "next", "return", "die", "warn"
    ];
