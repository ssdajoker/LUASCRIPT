/**
 * Groovy Parser - C-Family Language
 * Parses groovy code to canonical AST for IR pipeline
 */

const { BaseParser } = require("./base_parser");

class GroovyParser extends BaseParser {
  constructor(source) {
    super(source);
    this.keywords = [
      "function", "class", "if", "while", "for", "switch", "try", "catch", "throw", "return", "def", "static", "import", "package", "assert", "as"
    ];
    this.operators = ["===", "!==", "==", "!=", "<=", ">=", "&&", "||", "?.", "*.", ".&"];
  }
