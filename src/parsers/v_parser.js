/**
 * V Parser - C-Family Language
 * Parses v code to canonical AST for IR pipeline
 */

const { BaseParser } = require("./base_parser");

class VParser extends BaseParser {
  constructor(source) {
    super(source);
    this.keywords = [
      "function", "class", "if", "while", "for", "switch", "try", "catch", "throw", "return", "mut", "pub", "const", "struct", "enum", "match"
    ];
    this.operators = ["===", "!==", "==", "!=", "<=", ">=", "&&", "||", "..", "..."];
  }
