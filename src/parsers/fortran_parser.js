/**
 * Fortran Parser - Legacy Language
 * Parses fortran code to canonical AST for IR pipeline
 */
...
class FortranParser extends BaseParser {
  constructor(source) {
    super(source);
    this.keywords = [
      "PROGRAM", "SUBROUTINE", "FUNCTION", "IF", "THEN", "ELSE", "ELSEIF", "ENDIF", "DO", "ENDDO", "END", "CALL", "RETURN", "IMPLICIT", "INTEGER", "REAL", "LOGICAL", "CHARACTER"
    ];
    this.operators = [".EQ.", ".NE.", ".LT.", ".LE.", ".GT.", ".GE.", ".AND.", ".OR.", ".NOT."];
  }
