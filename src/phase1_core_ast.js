...
class DoWhileStatementNode extends ASTNode {
  constructor(body, test, properties = {}) {
    super("DoWhileStatement", properties);
    this.body = body;
    this.test = test;
    this.addChild(body);
    this.addChild(test);
...
class AwaitExpressionNode extends ASTNode {
  constructor(argument, properties = {}) {
    super("AwaitExpression", properties);
    this.argument = argument;
    if (argument) this.addChild(argument);
  }
}
...
class YieldExpressionNode extends ASTNode {
  constructor(argument = null, delegate = false, properties = {}) {
    super("YieldExpression", properties);
    this.argument = argument;
...
/** Represents a default parameter pattern (e.g., param = value). */
class AssignmentPatternNode extends ASTNode {
  constructor(left, right, properties = {}) {
    super("AssignmentPattern", properties);
    this.left = left;
    this.right = right;
    if (left) this.addChild(left);
    if (right) this.addChild(right);
...
/** Represents a rest parameter element (e.g., ...args). */
class RestElementNode extends ASTNode {
  constructor(argument, properties = {}) {
    super("RestElement", properties);
    this.argument = argument;
    if (argument) this.addChild(argument);
  }
}

/** Represents a spread element in calls or literals (e.g., ...args). */
