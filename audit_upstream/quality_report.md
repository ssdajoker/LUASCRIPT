...
/home/mrjenkins/luascript_upstream/examples/phase1b_demo.js
...
/home/mrjenkins/luascript_upstream/src/core_transpiler.js
  123:25  warning  'category' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/enhanced_operators.js
...
/home/mrjenkins/luascript_upstream/src/enhanced_transpiler.js
...
/home/mrjenkins/luascript_upstream/src/index.js
  301:15  warning  'report' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/optimized_transpiler.js
   ...
   37:21  warning  'poolName' is assigned a value but never used      no-unused-vars
  235:15  warning  'codeBuffer' is assigned a value but never used    no-unused-vars
  612:20  warning  'astResult' is assigned a value but never used     no-unused-vars
  612:31  warning  'luaGenResult' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/parser.js
  665:18  warning  'error' is defined but never used                no-unused-vars
  679:13  warning  'expr' is never reassigned. Use 'const' instead  prefer-const

/home/mrjenkins/luascript_upstream/src/performance_tools.js
  ...
  414:13  warning  'appliedOptimizations' is never reassigned. Use 'const' instead  prefer-const
  587:18  warning  'error' is defined but never used                                no-unused-vars
  626:18  warning  'error' is defined but never used                                no-unused-vars

/home/mrjenkins/luascript_upstream/src/phase1_core_lexer.js
  224:15  warning  'start' is assigned a value but never used  no-unused-vars
  333:15  warning  'start' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/phase1_core_parser.js
  ...
  766:22  warning  'error' is defined but never used                         no-unused-vars

/home/mrjenkins/luascript_upstream/src/phase2_core_interpreter.js
   ...
   628:23  warning  Expected '===' and instead saw '=='                               eqeqeq
   955:36  warning  Expected '===' and instead saw '=='                               eqeqeq
   956:36  warning  Expected '!==' and instead saw '!='                               eqeqeq
  1209:27  warning  Expected '!==' and instead saw '!='                               eqeqeq
  1232:27  warning  Expected '!==' and instead saw '!='                               eqeqeq

/home/mrjenkins/luascript_upstream/src/phase2_core_modules.js
  193:26  warning  'error' is defined but never used  no-unused-vars
  217:26  warning  'error' is defined but never used  no-unused-vars
  230:22  warning  'error' is defined but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/phase5_enterprise_optimization.js
  362:21  warning  'type' is assigned a value but never used         no-unused-vars
  717:15  warning  'startMemory' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/phase6_production_deployment.js
    9:7   warning  'path' is assigned a value but never used  no-unused-vars
  162:56  warning  Expected '===' and instead saw '=='        eqeqeq
  164:56  warning  Expected '!==' and instead saw '!='        eqeqeq

/home/mrjenkins/luascript_upstream/src/phase9_ecosystem.js
  ...
  1107:30  warning  'depVersion' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/src/runtime_system.js
   10:31  warning  'parentPort' is assigned a value but never used  no-unused-vars
   10:43  warning  'workerData' is assigned a value but never used  no-unused-vars
  513:18  warning  'error' is defined but never used                no-unused-vars

/home/mrjenkins/luascript_upstream/src/unified_luascript.js
  128:17  warning  'result' is never reassigned. Use 'const' instead  prefer-const
  428:18  warning  'error' is defined but never used                  no-unused-vars
  446:18  warning  'error' is defined but never used                  no-unused-vars
  465:18  warning  'error' is defined but never used                  no-unused-vars
  477:13  warning  'score' is never reassigned. Use 'const' instead   prefer-const
  488:13  warning  'score' is never reassigned. Use 'const' instead   prefer-const
  496:13  warning  'score' is never reassigned. Use 'const' instead   prefer-const
  510:13  warning  'score' is never reassigned. Use 'const' instead   prefer-const

/home/mrjenkins/luascript_upstream/src/wasm_backend.js
...
/home/mrjenkins/luascript_upstream/test/test_enhanced_transpiler.js
...
/home/mrjenkins/luascript_upstream/test/test_phase1_6_comprehensive.js
...
/home/mrjenkins/luascript_upstream/test/test_unified_system.js
  274:13  warning  'global' is not defined  no-undef
  275:13  warning  'global' is not defined  no-undef

/home/mrjenkins/luascript_upstream/test_optimizations.js
  237:15  warning  'result' is assigned a value but never used  no-unused-vars

/home/mrjenkins/luascript_upstream/tests/test_memory_management.js
  213:11  warning  'obj1' is assigned a value but never used  no-unused-vars
  216:11  warning  'obj2' is assigned a value but never used  no-unused-vars
