...
const CONFIG = {
  ...
  activeDocs: [
    ...
    'docs/LUASCRIPT_RELEASE_IR_SURFACE_CONTRACT.md',
    'docs/LUASCRIPT_PUBLIC_API_RUNTIME_CONTRACT.md',
    'docs/LUASCRIPT_DENALI_PACKAGE_MIGRATION_NOTES.md',
    'docs/LUASCRIPT_DENALI_COMPATIBILITY_MATRIX.md',
    'docs/LUASCRIPT_DENALI_RELEASE_BLOCKING_POLICY.md',
  ...
  requiredLinks: [
    ...
    },
    {
      ...
      mustContain: ['docs/INDEX.md', 'active-docs map', 'docs/LUASCRIPT_BIG_REMAINING_CLIMB_MASTER_LEDGER.md', 'docs/LUASCRIPT_1_0_EXIT_CRITERIA.md', 'docs/LUASCRIPT_CANONICAL_IR_SEMANTICS_INVENTORY.md', 'docs/LUASCRIPT_CANONICAL_IR_SEMANTICS_SPEC_V0.md', 'docs/LUASCRIPT_RELEASE_IR_SURFACE_CONTRACT.md', 'docs/LUASCRIPT_PUBLIC_API_RUNTIME_CONTRACT.md', 'docs/LUASCRIPT_DENALI_PACKAGE_MIGRATION_NOTES.md', 'docs/LUASCRIPT_DENALI_COMPATIBILITY_MATRIX.md', 'docs/LUASCRIPT_DENALI_RELEASE_BLOCKING_POLICY.md', 'docs/LUASCRIPT_CONFORMANCE_EVIDENCE_BINDER.md', 'docs/quick-start/README.md', 'docs/architecture/README.md', 'docs/reference/README.md'],
