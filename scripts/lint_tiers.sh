...
npm exec eslint "src/**/*.js" "lib/**/*.js" --ignore-pattern "src/ir/**/*.js" --ignore-pattern "src/backends/**/*.js" --max-warnings 200 --format html --output-file "${REPORT_DIR}/general.html"
