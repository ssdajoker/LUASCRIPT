...
- Gaussian graphics route: [GSS_AGSS_CAPABILITY_ROUTE.md](GSS_AGSS_CAPABILITY_ROUTE.md) defines the current GSS/AGSS dogfood evidence boundary, browser/graphics capability stages, and Canon Agent Bridge receipt contract.
