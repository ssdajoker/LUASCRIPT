...
| Transpiler & pipeline suite | ✅ | `npm run test:legacy:transpiler` -> validates transpile/execute and the advisory evidence snapshot (`testFullPipeline`, `testEvidenceSnapshot`). |
